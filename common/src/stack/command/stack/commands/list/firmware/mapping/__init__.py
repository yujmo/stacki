...
class Command(stack.commands.list.firmware.command, stack.commands.HostArgumentProcessor):
	"""
	...
	<example cmd="stack list firmware mapping">
	Lists all of the firmware mappings for all hosts.
	</example>

	<example cmd="stack list firmware mapping switch-13-11">
	Lists all of the firmware mappings for the host named switch-13-11.
	</example>

	<example cmd="stack list firmware mapping switch-13-11 switch-13-12 versions=3.6.5002,3.6.8010 make=mellanox model=m7800">
	...
	<example cmd="stack list firmware mapping versions=3.6.5002,3.6.8010 make=mellanox model=m7800">
